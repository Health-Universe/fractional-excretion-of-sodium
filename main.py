...
urine_na = st.number_input(value=0.01, 'Urine Sodium Concentration (mmol/L)')
serum_na = st.number_input(value=0.01, 'Serum Sodium Concentration (mmol/L)')
urine_cr = st.number_input(value=0.01, 'Urine Creatinine Concentration (umol/L)')
serum_cr = st.number_input(value=0.01, 'Serum Creatinine Concentration (umol/L)')
